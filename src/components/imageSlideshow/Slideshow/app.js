...
class Slideshow extends React.Component {
    ...
    componentDidMount() {
        //console.info("init componentDidMount...");
    	this.initImageSize();
    ...
    handleModalOpen(initImage) {
        //console.info("init handleModalOpen...");
    	this.onAnimate = true;
    ...
    handleBeforeModalOnOpen(nodeModal) {
        //console.info("init handleBeforeModalOnOpen...");
        let self = this;
    ...
    initImageSize() {
        ...
        //console.info("imgSizeData:",imgSizeData,imgSizeData.length);
        if(this.props.imgs) {
            this.setState({
    ...
    calSingleImageSize(urlIndex) {
        if(this.state.imageSize && this.props.imgs) {
            let imgSizeData = JSON.parse(JSON.stringify(this.state.imageSize));
            //console.info("urlIndex",urlIndex,"imgs:",this.props.imgs);
        ...
        return (
            ...
            >
                ...
                <div className={styles.slider}>
                    ...
                    <div className={styles.screenOverlay}  onClick={this.handleModalClose}  onClickCapture={() => this.handleModalClose()}>
                    	X
                    </div>
                    <div
                    ...
                    <div className={styles.sliderImageListWrapper}>
                        {
                            (this.props.imgs && this.state.imageSize) && this.props.imgs.map((imageData,index)=> {
                                ...
                                //console.info("index:",index,"this.state.imageSize[index]:",this.state.imageSize[index]);
